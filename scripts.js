document.addEventListener('DOMContentLoaded', () => {
    ...
    // Ensures we match the ID exactly so it doesn't crash
    ...
    const portfolioData = {
        home: `
            <div class="fade-in">
                ...
                <p class="summary">
                    DevOps / SRE Engineer with hands-on experience in Site Reliability Engineering, DevSecOps, AIOps, and cloud infrastructure. Managed 6+ enterprise Kubernetes and WebLogic environments.
                </p>
    ...
    function updateContent(targetKey) {
        ...
        // Clear existing content to re-trigger the fade-in animation
